...
<script>
    function ValidateLogin(){
    	...
    	xhttp.open("GET", "ValidateLogin?username=" + document.myform.username.value
	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="ValidateLogin" method="post" name = "myform">
					<div class="form-group">
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-user"></i></span>
							<input type="text" name = "username" class="form-control" name="username" placeholder="Username" required="required">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
					...
					<div class="form-group">
						<button type="submit" class="btn btn-danger btn-block btn-lg">Sign In</button>
					</div>
					<div id="errorMsg"><% out.println("<p>" + error + "</p>"); %></div>
					<div class="modal-footer">Don't have an account? <a href = "./ftoregister.jsp">Create one</a></div>
				</form>
			</div>
